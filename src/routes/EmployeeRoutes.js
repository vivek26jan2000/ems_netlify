...
EmployeeRoutes.get(
  "/EmployeeLeaves/:id",
  EmployeeControllers.getEmployeeLeaves
);

// update the Employee Payroll Status
EmployeeRoutes.post(
  "/UpdatePayrollStatus",
  EmployeeControllers.updatePayrollStatus
);

// Get the employees payroll details
EmployeeRoutes.get("/payrollDetails", EmployeeControllers.getPayrollDetails);
