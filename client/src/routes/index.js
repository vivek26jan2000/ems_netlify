...
const EmployeeAttendencePage = React.lazy(() =>
  import("../pages/Employee/EmployeeAttendencePage")
);
    ...
    return (
      <Routes>
        <Route to="/" element={<Layout />}>
          ...
          <Route
            path="/attendence"
            element={<LoadComponent component={EmployeeAttendencePage} />}
          />
          <Route
    ...
    return (
      <Routes>
        <Route to="/" element={<Layout />}>
          ...
          <Route
            path="/payroll"
            element={<LoadComponent component={PayrollPage} />}
          />
          <Route path="*" element={<Navigate to="/dashboard" />} />
        </Route>
      </Routes>
